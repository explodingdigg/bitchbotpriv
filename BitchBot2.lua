...
do
	...
	function CreateNotification(t, customcolor) -- TODO i want some kind of prioritized message to the notification list, like a warning or something. warnings have icons too maybe? idk??
								...
								local mencol = customcolor
									or (
										menu:GetVal("Settings", "Cheat Settings", "Menu Accent")
											and Color3.fromRGB(unpack(menu:GetVal("Settings", "Cheat Settings", "Menu Accent", "color")))
		...
		local color = (menu and menu.GetVal) and customcolor
			or menu:GetVal("Settings", "Cheat Settings", "Menu Accent") and Color3.fromRGB(unpack(menu:GetVal("Settings", "Cheat Settings", "Menu Accent", "color")))
			or Color3.fromRGB(127, 72, 163)
...
if
	game.PlaceId == 292439477
	or game.PlaceId == 299659045
	or game.PlaceId == 5281922586
	or game.PlaceId == 3568020459
...
function menu.Initialize(menutable)
					...
					if content ~= nil then
						for k2, v2 in pairs(content) do
							if v2.type == "toggle" then
								...
								menu.options[v.name][g_name][v2.name][4] =
									Draw:Toggle(v2.name, v2.value, unsafe, v1.x + 8, v1.y + y_pos, tabz[k])
								...
								if v2.extra ~= nil then
									if v2.extra.type == "keybind" then
										...
										menu.options[v.name][g_name][v2.name][5][3] =
											{ v1.x + v1.width - 52, y_pos + v1.y - 2 }
										menu.options[v.name][g_name][v2.name][5][5] = false
										menu.options[v.name][g_name][v2.name][5].toggletype = v2.extra.toggletype == nil and 1
											or v2.extra.toggletype
										menu.options[v.name][g_name][v2.name][5].relvalue = false
										menu.options[v.name][g_name][v2.name][5].bind =
											table.insert(menu.keybinds, {
												menu.options[v.name][g_name][v2.name],
												tostring(v2.name),
												tostring(g_name),
												tostring(v.name),
									...
									elseif v2.extra.type == "double colorpicker" then
										...
										for i = 1, 2 do
											...
											menu.options[v.name][g_name][v2.name][5][1][i][3] =
												{ v1.x + v1.width - 38 - ((i - 1) * 34), y_pos + v1.y - 1 }
							...
							elseif v2.type == "slider" then
								...
								menu.options[v.name][g_name][v2.name][3] =
									{ v1.x + 7, v1.y + y_pos - 1, v1.width - 16 }
								...
								menu.options[v.name][g_name][v2.name][7] =
									{ v1.x + 7 + v1.width - 38, v1.y + y_pos - 1 }
								menu.options[v.name][g_name][v2.name].decimal = v2.decimal == nil and nil
									or v2.decimal
							...
							elseif v2.type == "dropbox" then
								...
								if v2.x == nil then
									...
									menu.options[v.name][g_name][v2.name][4] =
										Draw:Dropbox(v2.name, v2.value, v2.values, v2.x + 8, v2.y, v2.w, tabz[k])
								end
							...
							elseif v2.type == "button" then
								...
								if v2.x == nil then
									menu.options[v.name][g_name][v2.name][3] =
										{ v1.x + 7, v1.y + y_pos - 1, v1.width - 16 }
									menu.options[v.name][g_name][v2.name][4] =
										Draw:Button(v2.name, v1.x + 8, v1.y + y_pos, v1.width - 16, tabz[k])
									y_pos += 28
								else
									menu.options[v.name][g_name][v2.name][3] = { v2.x + 7, v2.y - 1, v2.w }
									menu.options[v.name][g_name][v2.name][4] =
										Draw:Button(v2.name, v2.x + 8, v2.y, v2.w, tabz[k])
								end
							elseif v2.type == "textbox" then
								menu.options[v.name][g_name][v2.name] = {}
								menu.options[v.name][g_name][v2.name][4] =
									Draw:TextBox(v2.name, v2.text, v1.x + 8, v1.y + y_pos, v1.width - 16, tabz[k])
							...
							elseif v2.type == "image" then
								menu.options[v.name][g_name][v2.name] = {}
								menu.options[v.name][g_name][v2.name][1] =
									Draw:ImageWithText(v2.size, nil, v2.text, v1.x + 8, v1.y + y_pos, tabz[k])
								menu.options[v.name][g_name][v2.name][2] = v2.type
							end
						end
					end
	...
	function menu:GetKey(tab, groupbox, name)
		...
		if option.toggletype ~= 0 then
			...
			return option.relvalue, option.lastvalue
		else
			return false
		end
	end
				...
				for k1, v1 in pairs(v) do
					for k2, v2 in pairs(v1) do
						if v2[2] == "toggle" then
							...
							if v2[5] ~= nil then
								...
								elseif v2[5][2] == "single colorpicker" then
									...
									for i = 2, 3 do
										v2[5][4][i].Color =
											RGB(v2[5][1][1] - 40, v2[5][1][2] - 40, v2[5][1][3] - 40)
									end
						...
						elseif v2[2] == "slider" then
							...
							for i = 1, 4 do
								v2[4][i].Size =
									Vector2.new((v2[3][3] - 4) * ((v2[1] - v2[6][1]) / (v2[6][2] - v2[6][1])), 2)
							end
							...
							for k2, v2 in pairs(v1) do
								...
								elseif v2[2] == "list" then
									...
									if #v2[5] > v2[6] then
										for i = 1, v2[6] do
											if
												menu:MouseInMenu(v2[8][1], v2[8][2] + (i * 22) - 5, v2[8][3], 22)
											then
										...
										if v2[5][i + v2[3] - 1] ~= nil then
											for i1 = 1, v2[7] do
												...
												if v2[5][i + v2[3] - 1][i1][1] == v2[1] and i1 == 1 then
													if
														menu.options["Settings"]["Cheat Settings"]["Menu Accent"][1]
													then
														local clr =
															menu.options["Settings"]["Cheat Settings"]["Menu Accent"][5][1]
														v2[4].liststuff.words[i][i1].Color =
															RGB(clr[1], clr[2], clr[3])
													else
														v2[4].liststuff.words[i][i1].Color =
															RGB(menu.mc[1], menu.mc[2], menu.mc[3])
													end
												else
		...
		if menu then
			...
			if menu.open then
				if menu.tabnames[menu.activetab] == "Settings" then
					bbmenu[27].Text = menu:GetVal("Settings", "Cheat Settings", "Custom Menu Name")
							and menu:GetVal("Settings", "Cheat Settings", "MenuName")
						or "Bitch Bot"
...
menu.connections.heartbeatmenu = game.RunService.Heartbeat:Connect(function() --ANCHOR MENU HEARTBEAT
	...
	if tick() > lasttick + 0.25 then
		...
		graphs.incoming.sides[2].Position =
			Vector2.new(graphs.incoming.pos.x - ((#numstr + 1) * 7), graphs.incoming.pos.y - 7)
		...
		graphs.outgoing.sides[2].Position =
			Vector2.new(graphs.outgoing.pos.x - ((#numstr + 1) * 7), graphs.outgoing.pos.y - 7)
...
if menu.game == "uni" then --SECTION UNIVERSAL
	...
	local function SpeedHack()
		...
		if
			menu:GetVal("Misc", "Movement", "Speed")
	...
	local function Aimbot()
		if
			menu:GetVal("Aimbot", "Aimbot", "Enabled")
			and INPUT_SERVICE:IsKeyDown(menu:GetVal("Aimbot", "Aimbot", "Enabled", "keybind"))
		then
			...
			for i, v in ipairs(Players:GetPlayers()) do
				...
				if v.Character ~= nil and v.Character:FindFirstChild("HumanoidRootPart") then
					...
					if
						checks[3]
						and LOCAL_PLAYER:DistanceFromCharacter(v.Character.HumanoidRootPart.Position) / 5 > menu:GetVal("Aimbot", "Aimbot", "Max Distance")
					then
						continue
					end
	...
	menu.connections.inputstart2 = INPUT_SERVICE.InputBegan:Connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 then
			if menu.open then
				if
					menu.tickbase_manip_added == false
					and menu:GetVal("Misc", "Exploits", "Enable Tick Manipulation")
				then
					shared.tick_ref = hookfunc(tick, function()
						...
						if not menu then
							return shared.tick_ref()
						elseif
							menu:GetVal("Misc", "Exploits", "Enable Tick Manipulation")
							and menu:GetVal("Misc", "Exploits", "Shift Tick Base")
							and INPUT_SERVICE:IsKeyDown(menu:GetVal("Misc", "Exploits", "Shift Tick Base", "keybind"))
						then
				...
				if
					menu:GetVal("Visuals", "Misc", "Draw Aimbot FOV")
					and menu:GetVal("Aimbot", "Aimbot", "Enabled")
				then
	...
	local function unikeycheck(actionName, inputState, inputObject)
		if actionName == "BB UNI check" then
			if inputState == Enum.UserInputState.Begin then
				if
					menu:GetVal("Misc", "Movement", "Fly")
					and inputObject.KeyCode == menu:GetVal("Misc", "Movement", "Fly", "keybind")
				then
	...
	menu.connections.renderstepped2 = game.RunService.RenderStepped:Connect(function()
		...
		if menu:GetVal("Visuals", "Misc", "Custom Crosshair") then
			...
			if menu:GetVal("Visuals", "Misc", "Crosshair Position") == 1 then
				...
				menu.crosshair.outline[1].Position =
					Vector2.new(SCREEN_SIZE.x / 2 - size - 1, SCREEN_SIZE.y / 2 - 1)
				menu.crosshair.outline[2].Position =
					Vector2.new(SCREEN_SIZE.x / 2 - 1, SCREEN_SIZE.y / 2 - 1 - size)
			else
		...
		CreateThread(function()
			...
			for i, v in ipairs(Players:GetPlayers()) do
				...
				if v.Character ~= nil and v.Character:FindFirstChild("HumanoidRootPart") then
					...
					if
						checks[3]
						and LOCAL_PLAYER:DistanceFromCharacter(v.Character.HumanoidRootPart.Position) / 5 > menu:GetVal("Visuals", "ESP Settings", "Max Distance")
					then
						continue
					end
			...
			for i, v in ipairs(organizedPlayers) do
				...
				local top, top_isrendered =
					workspace.CurrentCamera:WorldToViewportPoint(head.Position + (torso.UpVector * 1.3) + cam.UpVector)
				local bottom, bottom_isrendered =
					workspace.CurrentCamera:WorldToViewportPoint(torso.Position - (torso.UpVector * 3) - cam.UpVector)
				...
				if top_isrendered or bottom_isrendered then
					...
					if menu:GetVal("Visuals", "Player ESP", "Head Dot") then
						...
						if head then
							...
							local headdotpos =
								workspace.CurrentCamera:WorldToViewportPoint(Vector3.new(headpos.x, headpos.y, headpos.z))
							local headdotpos_b =
								workspace.CurrentCamera:WorldToViewportPoint(Vector3.new(headpos.x, headpos.y - 0.3, headpos.z))
					...
					if menu:GetVal("Visuals", "Player ESP", "Name") then
						local name_pos =
							Vector2.new(math.floor(boxtop.x + boxsize.w * 0.5), math.floor(boxtop.y - 15))
					...
					if menu:GetVal("Visuals", "Player ESP", "Distance") then
						local dist_pos =
							Vector2.new(math.floor(boxtop.x + boxsize.w * 0.5), boxtop.y + boxsize.h + y_spot)
	...
	menu.connections.esprenderloop = game.RunService.RenderStepped:Connect(function()
		...
		if menu:GetVal("Visuals", "Player ESP", "Enabled") then
			...
			for i, player in pairs(Players:GetPlayers()) do
				...
				if
					player.Character:FindFirstChild("UpperTorso") == nil
					or player.Character:FindFirstChild("Head") == nil
				then
					continue
				end
				...
				if top_isrendered or bottom_isrendered then
					...
					if
						menu:GetVal("Visuals", "ESP Settings", "Highlight Priority")
						and table.find(menu.priority, player.Name)
					then
					...
					elseif
						menu:GetVal("Visuals", "ESP Settings", "Highlight Friends")
						and table.find(menu.friends, player.Name)
					then
...
elseif menu.game == "pf" then --SECTION PF BEGIN
	...
	for i = 1, 50 do
		Draw:FilledRect(
			...
			2,
			20,
			{ this_is_really_ugly, this_is_really_ugly, this_is_really_ugly, 255 },
			allesp[10][3]
		)
	end
	for i = 1, 17 do
	...
	for i = 1, #gc do
		...
		if garbagetype == "table" then
			...
			elseif
				rawget(garbage, "task")
				and rawget(garbage, "dependencies")
				and rawget(garbage, "name") == "camera"
			then
				...
				rawset(garbage, "task", function(...)
					...
					if not client.superaastart then
						if
							ragebot.target
							and menu:GetVal("Rage", "Aimbot", "Rotate Viewmodel")
							and client.logic.currentgun
					...
					if
						client.logic.currentgun
						and menu:GetVal("Visuals", "Viewmodel", "Enabled")
						and client.logic.currentgun.type ~= "KNIFE"
					then
							...
							if type(v1) == "function" and is_synapse_function(v1) then
								for k2, v2 in next, getupvalues(v1) do
									if
										type(v2) == "function"
										and islclosure(v2)
										and not is_synapse_function(v2)
									then
										setupvalue(v, k1, v2)
									end
								end
		...
		if newupdater then -- lazy fix...................
			...
			newupdater.step = function(what, what1)
				if not menu then
					...
					if
						menu:GetVal("Rage", "Aimbot", "Enabled")
						or menu:GetKey("Visuals", "Local", "Third Person")
						or keybindtoggles.superaa
					then
						return step(3, true)
	...
	local spam_words = {
		...
		"Noclip Cheat",
		"Bullet Check Bypass",
		"client.char:setbasewalkspeed(999) SPEED CHEAT.",
		"diff = dot(bulletpos, intersection - step_pos) / dot(bulletpos, bulletpos) * dt",
		"E = MC^2",
					...
					if Part.ClassName ~= "Model" and Part.Name ~= "HumanoidRootPart" then
						...
						if not Part:FindFirstChild("c88") then
							...
							for i = 0, 1 do
								...
								elseif
									menu:GetVal("Visuals", "ESP Settings", "Highlight Friends", "color")
									and table.find(menu.friends, player.Name)
								then
									xqz = menu:GetVal("Visuals", "ESP Settings", "Highlight Friends", "color", true)
									col = bColor:Mult(xqz, 0.6)
								elseif
									menu:GetVal("Visuals", "ESP Settings", "Highlight Aimbot Target")
									and (
										player == legitbot.target
										or player == ragebot.target
									)
								then
									xqz = menu:GetVal(
										"Visuals",
			...
			if current_time % speed == 0 and current_time ~= last_chat then
				...
				if cs ~= 1 then
					...
					if curchoice ~= nil then
						curchoice = menu:GetVal("Misc", "Extra", "Chat Spam Repeat") and string.rep(curchoice, 100)
							or curchoice
		...
		mt.__newindex = newcclosure(function(self, id, val)
			...
			if client.char.alive then
				if self == workspace.Camera then
					if id == "CFrame" then
						if
							not keybindtoggles.superaa
							and menu:GetVal("Visuals", "Local", "Third Person")
							and menu:GetKey("Visuals", "Local", "Third Person")
						then
	...
	do --ANCHOR camera function definitions.
		...
		function camera:IsVisible(Part, Parent, origin)
			...
			local hit, position =
				workspace:FindPartOnRayWithWhitelist(Ray.new(origin, Part.Position - origin), client.roundsystem.raycastwhitelist)
	...
	do --ANCHOR ragebot definitions
		...
		function ragebot:GetResolvedPosition(player, curbodyparts)
			...
			if misses and misses > 2 then
				...
				if rep and (modmisses and (rep - curbodyparts.torso.Position).Magnitude > 18) then
		...
		function ragebot:GetDamage(distance, headshot)
			...
			return (
					distance < r0 and d0
					or distance < r1 and (d1 - d0) / (r1 - r0) * (distance - r0) + d0
					or d1
		...
		function ragebot:bulletcheck_legacy(origin, destination, penetration, whitelist)
			...
			local hit, enter =
				workspace:FindPartOnRayWithWhitelist(Ray.new(origin, dir), client.roundsystem.raycastwhitelist)

			if hit then
				local unit = dir.Unit
				local maxextent = hit.Size.Magnitude * unit
				local _, exit =
					workspace:FindPartOnRayWithWhitelist(Ray.new(enter + maxextent, -maxextent), { hit })
		...
		function ragebot:CanPenetrate(origin, target, penetration, whitelist)
			...
			if autowallchoice ~= 1 and autowallchoice == 2 then
				local d, t =
					client.trajectory(origin, GRAVITY, target.Position, client.logic.currentgun.data.bulletspeed)
				if not t then
					return
				end
				if not d then
		...
		function ragebot:AimAtTarget(part, target, head, origin, resolved, intersection)
			...
			if menu:GetVal("Rage", "Aimbot", "Auto Shoot") then
				local firerate = type(client.logic.currentgun.data.firerate) == "table" and client.logic.currentgun.data.firerate[1]
					or client.logic.currentgun.data.firerate
		...
		function ragebot:GetTarget(hitboxPriority, hitscan, players, origin)
				...
				if player.Team ~= LOCAL_PLAYER.Team and player ~= LOCAL_PLAYER then
					...
					if curbodyparts and client.hud:isplayeralive(player) then
						...
						if resolvedPosition then
							...
							if updater then
								local upvals = getupvalues(updater.step)
								if upvals[4] then
									upvals[4].p = resolvedPosition
									upvals[4].t = resolvedPosition
									upvals[4].v = Vector3.new()
								end
								--resolved = true
							end
						end
									...
									elseif autowall ~= 1 then
										...
										if aw_resolve then
											...
											if axisPosition then
												...
												cpart = bone
												theplayer = player
												intersection = bulletintersection
													or resolvedPosition
													or newbone.Position
			...
			if (cpart and theplayer and closest and firepos) and menu:GetKey("Misc", "Exploits", "Crimwalk") then
				if menu:GetVal("Misc", "Exploits", "Disable Crimwalk on Shot") then
					client.net:send("repupdate", client.lastrepupdate)
			...
			return cpart, theplayer, closest, firepos, head, newbone, intersection
		end
		...
		function ragebot:GetKnifeTargets()
			...
			for i, ply in ipairs(Players:GetPlayers()) do
				...
				if
					not table.find(menu.priority, ply.Name)
					and menu:GetVal("Misc", "Extra", "Target Only Priority Players")
				then
					continue
				end
				...
				if ply.Team ~= LOCAL_PLAYER.Team and client.hud:isplayeralive(ply) then
					...
					local part1, ray_pos =
						workspace:FindPartOnRayWithIgnoreList(Ray.new(client.cam.cframe.p, target_direction), ignore)
					local part2, ray_pos =
		...
		function ragebot:CubicHitscan(studs, origin, selectedpart) -- Scans in a cubic square area of size (studs) and resolves a position to hit target at
			...
			for i, point in pairs(dapointz.corner) do
				local penetrated =
					ragebot:CanPenetrate(point, selectedpart, client.logic.currentgun.data.penetrationdepth)
		...
		function ragebot:HitscanOnAxes(origin, person, bodypart, hitboxshift)
			...
			if resolverPoints[8] then
				...
				local dist, thick
				if hitboxshift then
					hitbox, whitelist, method = getHitboxShift(person, bodypart, position)
				end
			...
			for i = 1, math.min(#hitscanOffsets, maxPoints) do -- this makes it skip if ur using low max Hitscan Points rofl suace super fast speed cheat :)
				if resolverPoints[i] == true then -- this is so that it doesn't skip for the origin point
					...
					local dist, thick
					if hitboxshift then
						hitbox, whitelist, method = getHitboxShift(person, bodypart, position.p)
					end
					local pen, exited, bulletintersection =
		...
		function ragebot:MainLoop() -- lfg
			...
			ragebot:Stance()
			if
				menu:GetVal("Rage", "Fake Lag", "Enabled")
				and not menu:GetVal("Rage", "Fake Lag", "Manual Choke")
			then
				if
					(not fakelagpos or not fakelagtime)
					or ((client.cam.cframe.p - fakelagpos).Magnitude > menu:GetVal("Rage", "Fake Lag", "Fake Lag Distance") or tick() - fakelagtime > 1)
					or not client.char.alive
				then
					fakelagtime = tick()
			...
			if client.char.alive then
				if
					menu:GetVal("Misc", "Movement", "Circle Strafe")
					and menu:GetKey("Misc", "Movement", "Circle Strafe")
				then
			...
			if
				client.char.alive
				and menu:GetVal("Rage", "Aimbot", "Enabled")
				and menu:GetKey("Rage", "Aimbot", "Enabled", true)
			then
				if client.logic.currentgun and client.logic.currentgun.type ~= "KNIFE" then -- client.loogic.poop.falsified_directional_componenet = Vector8.new(math.huge) [don't fuck with us]
					if ragebot:LogicAllowed() then
						...
						local targetPart, targetPlayer, fov, firepos, head, resolved, intersection =
							ragebot:GetTarget(prioritizedpart, hitscanpreference, priority_list)
						if not targetPart and not menu:GetVal("Misc", "Extra", "Target Only Priority Players") then
							targetPart, targetPlayer, fov, firepos, head, resolved, intersection =
								ragebot:GetTarget(prioritizedpart, hitscanpreference, playerlist)
						end
						ragebot:AimAtTarget(targetPart, targetPlayer, head, firepos, resolved, intersection)
					end
				else
					self.target = nil
				end
		...
		function ragebot:Stance()
			if LOCAL_PLAYER.Character and LOCAL_PLAYER.Character:FindFirstChild("Humanoid") then
				if
					menu:GetVal("Rage", "Anti Aim", "Hide in Floor")
					and menu:GetVal("Rage", "Anti Aim", "Enabled")
					and not LOCAL_PLAYER.Character.Humanoid.Jump
				then
	...
	do
		...
		if client.newgrenade then
			...
			oldnewgrenade = hookfunction(client.newgrenade, function(thrower, gtype, gdata)
				if
					menu and gdata.blowuptime > 0 and thrower.team ~= LOCAL_PLAYER.Team
					or thrower == LOCAL_PLAYER
				then
					local lastrealpos
			...
			if found8 then
				clienteventfuncs[hash] = function(...)
					...
					if menu:GetVal("Misc", "Extra", "Auto Martyrdom") then
						...
						if
							not (
								table.find(menu.friends, args[1].Name)
								and menu:GetVal("Misc", "Extra", "Ignore Friends")
							)
							and menu:GetVal("Misc", "Exploits", "Grenade Teleport")
							and args[1] ~= LOCAL_PLAYER
						then
							if
								not table.find(menu.priority, args[1].Name)
								and menu:GetVal("Misc", "Extra", "Target Only Priority Players")
							then
								return
							end
	...
	do
		...
		function client.thickcastplayers(origin, direction) -- i might attempt to use this on bulletcheck later
			...
			for player, bodyparts in next, chartable do
				...
				if
					diff > 0
					and diff < directiondot
					and directiondot * dot(delta, delta) - diff * diff < directiondot * 6 * 6
				then
		...
		function misc:CreateBeam(origin_att, ending_att)
			...
			beam.Color =
				ColorSequence.new(menu:GetVal("Visuals", "Misc", "Bullet Tracers", "color", true), Color3.new(0, 0, 0))
			beam.Attachment0 = origin_att
			beam.Attachment1 = ending_att
		...
		function misc:Invisibility(val)
			...
			copy = rootpart:Clone()
			rootpart.CFrame = cf + Vector3.new(9e9, 9e9, 9e9)
		...
		function misc:RapidKill()
			...
			for k, v in next, team:GetPlayers() do
				...
				if table.find(menu.priority, v.Name) and client.hud:isplayeralive(v) then
					...
					local chosenpos = math.abs((curbodyparts.rootpart.Position - curbodyparts.torso.Position).Magnitude) > 10 and curbodyparts.rootpart.Position
						or curbodyparts.head.Position
					local args = {
						"FRAG",
						{
							frames = {
			...
			for k, v in next, team:GetPlayers() do
				...
				then
					if
						not table.find(menu.friends, v.Name)
						and menu:GetVal("Misc", "Extra", "Target Only Priority Players")
					then
						continue
					end
		...
		do
			...
			function client.char:jump(height)
				height = (menu and menu:GetVal("Misc", "Tweaks", "Jump Power"))
						and (height * menu:GetVal("Misc", "Tweaks", "Jump Power Percentage") / 100)
					or height
		...
		menu.connections.toggle_pressed_pf = TogglePressed:connect(function(tab, name, class)
			if name == "Enabled" and tab == "Weapon Modifications" then
				client.animation.player = (class[1] and menu:GetVal("Misc", "Weapon Modifications", "Remove Animations")) and animhook
					or client.animation.oldplayer
				client.animation.reset = (class[1] and menu:GetVal("Misc", "Weapon Modifications", "Remove Animations")) and animhook
					or client.animation.oldreset
			end
			if name == "Remove Animations" then
				client.animation.player = (class[1] and menu:GetVal("Misc", "Weapon Modifications", "Enabled")) and animhook
					or client.animation.oldplayer
				client.animation.reset = (class[1] and menu:GetVal("Misc", "Weapon Modifications", "Remove Animations")) and animhook
					or client.animation.oldreset
			end
		...
		function misc:AutoPeek()
			...
			if menu:GetKey("Rage", "Extra", "Auto Peek") and menu:GetVal("Rage", "Aimbot", "Enabled") then
				local hitscanpreference =
					misc:GetParts({ [menu:GetVal("Rage", "Aimbot", "Hitscan Priority")] = true })
				local prioritizedpart = menu:GetVal("Rage", "Aimbot", "Hitscan Priority")
				...
				if not self.autopeekposition then
					local targetPart, targetPlayer, fov, firepos, head, resolved =
						ragebot:GetTarget(prioritizedpart, hitscanpreference, nil, CFrame.new(origin))
				...
				if
					self.autopeekposition
					and not workspace:Raycast(client.lastrepupdate, self.autopeekposition - client.lastrepupdate, mapRaycast)
				then
		...
		function misc:MainLoop()
			...
			rootpart = self.newroot or rootpart
			...
			if rootpart and humanoid then
				if not CHAT_BOX.Active then
					...
					if menu:GetVal("Misc", "Movement", "Bypass Speed Checks") then
						client.net:send("repupdate", Camera.CFrame.Position, ragebot.angles) -- this is super shit
					end
					--misc:RoundFreeze()
		...
		do --ANCHOR send hook
			client.net.send = function(self, ...)
				...
				if menu and menu:GetVal("Misc", "Exploits", "Skin Changer") and args[1] == "changecamo" then
					...
					args[6].TextureProperties.Transparency = 1
						- menu:GetVal("Misc", "Exploits", "Skin Changer", "color")[4] / 255
					...
					args[6].BrickProperties.BrickColor =
						menu:GetVal("Misc", "Exploits", "Skin Changer", "color", true)
				...
				if args[1] == "chatted" then
					...
					if commandLocation == 1 then
						...
						if func then
							...
							return CreateNotification("Not a command, try \\cmdlist to see available commands.")
						end
					end
				end
				...
				if args[1] == "bullethit" or args[1] == "knifehit" then
					if
						table.find(menu.friends, args[2].Name)
						and menu:GetVal("Misc", "Extra", "Ignore Friends")
					then
						return
					end
				...
				if
					args[1] == "stance"
					and menu:GetVal("Rage", "Anti Aim", "Enabled")
					and menu:GetVal("Rage", "Anti Aim", "Force Stance") ~= 1
				then
					return
				end
				if
					args[1] == "sprint"
					and menu:GetVal("Rage", "Anti Aim", "Enabled")
					and menu:GetVal("Rage", "Anti Aim", "Lower Arms")
				then
					return
				end
				...
				if args[1] == "newgrenade" and menu:GetVal("Misc", "Exploits", "Grenade Teleport") then
					...
					for i, player in pairs(Players:GetPlayers()) do
						if
							table.find(menu.friends, player.Name)
							and menu:GetVal("Misc", "Extra", "Ignore Friends")
						then
							continue
						end
				...
				if args[1] == "newbullets" then
					...
					if ragebot.silentVector then
						...
						local hitpoint = ragebot.intersection -- fuckkkkkkkkk
						-- print(hitpoint)---WHYYY
						if not hitpoint then
							hitpoint = ragebot.targetpart.Position
				...
				elseif args[1] == "stab" then
					...
					menu:SetKey("Rage", "Fake Lag", "Manual Choke")
					if
						menu:GetVal("Rage", "Extra", "Knife Bot")
						and menu:GetKey("Rage", "Extra", "Knife Bot", true)
					then
			...
			do -- ANCHOR Legitbot definition defines legit functions
				...
				local function Move_Mouse(delta)
					...
					x = x > client.cam.maxangle and client.cam.maxangle
						or x < client.cam.minangle and client.cam.minangle
						or x
				...
				function legitbot:MainLoop()
					...
					if
						not menu.open
						and INPUT_SERVICE.MouseBehavior ~= Enum.MouseBehavior.Default
						and client.logic.currentgun
					then
						...
						if menu:GetVal("Legit", "Aim Assist", "Enabled") then
							...
							local hitboxPriority = menu:GetVal("Legit", "Aim Assist", "Hitscan Priority") == 1 and "head"
								or menu:GetVal("Legit", "Aim Assist", "Hitscan Priority") == 2 and "torso"
								or "closey :)"
							local hitscan = misc:GetParts(menu:GetVal("Legit", "Aim Assist", "Hitscan Points"))

							if
								client.logic.currentgun.type ~= "KNIFE" and INPUT_SERVICE:IsMouseButtonPressed(keybind)
								or keybind == 2
							then
								local priority_list = {}
								for k, PlayerName in pairs(menu.priority) do
								...
								local targetPart, closest, player =
									legitbot:GetTargetLegit(hitboxPriority, hitscan, priority_list)
						...
						if menu:GetVal("Legit", "Bullet Redirection", "Silent Aim") then
							...
							local hitboxPriority = hnum == 1 and "head"
								or hnum == 2 and "torso"
								or hnum == 3 and false
							local hitscan =
								misc:GetParts(menu:GetVal("Legit", "Bullet Redirection", "Hitscan Points"))
							local priority_list = {}
							for k, PlayerName in pairs(menu.priority) do
								if Players:FindFirstChild(PlayerName) then
									table.insert(priority_list, game.Players[PlayerName])
							...
							elseif client.logic.currentgun and client.logic.currentgun.barrel then
								...
								if client.logic.currentgun.type == "SHOTGUN" and barrel and barrel.Parent then
									...
									if trigger then
										...
										client:GetToggledSight(client.logic.currentgun).sightpart.Orientation =
											trigger.Orientation
									end
								end
							end
				...
				function legitbot:AimAtTarget(targetPart, smoothing, smoothtype)
					...
					if menu:GetVal("Legit", "Aim Assist", "Adjust for Bullet Drop") then
						if
							not client.logic.currentgun
							or not client.logic.currentgun.data
							or not client.logic.currentgun.data.bulletspeed
						then
							return
						end
					...
					if
						client.logic.currentgun
						and client.logic.currentgun.type ~= "KNIFE"
						and client.logic.currentgun:isaiming()
						and menu:GetVal("Legit", "Recoil Control", "Weapon RCS")
					then
						if
							client.logic.currentgun.data.blackscope and isPlayerScoped
							or client.logic.currentgun.data.blackscope
						then
					...
					if smoothtype == 1 then
						...
						local newMovement = aimbotMovement.Magnitude > unitMovement.Magnitude and unitMovement
							or aimbotMovement / 5
				...
				function legitbot:SilentAimAtTarget(targetPart)
					...
					local origin = client.logic.currentgun.isaiming() and client:GetToggledSight(client.logic.currentgun)
						or client.logic.currentgun.barrel.Position

					local target = targetPart.Position
					local dir, bulletTravelTime =
						client.trajectory(
							client.cam.cframe.p,
							GRAVITY,
							target,
					...
					if client.logic.currentgun.type == "SHOTGUN" then
						...
						client.logic.currentgun.barrel.Orientation =
			...
			elseif camera:IsVisible(Bone) then
							...
							for k, Bone in pairs(Parts) do
								if Bone.ClassName == "Part" and hitscan[k] then
									local fovToBone = camera:GetFOV(
										Bone,
										client.logic.currentgun:isaiming()
											and client:GetToggledSight(client.logic.currentgun).sightpart
									)
									if fovToBone < closest then
				...
				function legitbot:TriggerBot()
					...
					if
						menu:GetVal("Legit", "Trigger Bot", "Enabled")
						and menu:GetKey("Legit", "Trigger Bot", "Enabled", true)
					then
							...
							for player, bodyparts in next, getupvalue(client.replication.getallparts, 1) do
								if player.Team ~= LOCAL_PLAYER.Team then
									for bpartname, bodypart in next, bodyparts do
										if
											bodypart:IsA("Part")
											and bodypart.Transparency == 0
											and parts[bpartname]
										then
											if camera:IsVisible(bodypart) then
												local barrel = isaiming and gun.aimsightdata[1].sightpart
													or thebarrel
												...
												if delta.magnitude > 2050 then
													...
													if
														hit and hit:IsDescendantOf(bodypart.Parent.Parent)
														or hit == sphereHitbox
													then
			...
			local function renderVisuals()
				...
				if
					client.logic.currentgun
					and client.logic.currentgun.barrel
					and client.char.alive
					and menu:GetVal("Visuals", "Misc", "Laser Pointer")
				then
					...
					local barrel = client.logic.currentgun:isaiming()
							and client:GetToggledSight(client.logic.currentgun).sightpart
						or client.logic.currentgun.barrel
					if barrel.Parent then
						local trigger = barrel.Parent.Trigger
						local hit, hitpos =
							workspace:FindPartOnRayWithIgnoreList(Ray.new(barrel.Position, trigger.CFrame.LookVector * 100), ignore)
						local size = 6
				...
				if client.cam.type ~= "menu" then
					...
					local priority_color =
						menu:GetVal("Visuals", "ESP Settings", "Highlight Priority", "color", true)
					local priority_alpha = menu:GetVal("Visuals", "ESP Settings", "Highlight Priority", "color")[4] / 255
					...
					local target_color =
						menu:GetVal("Visuals", "ESP Settings", "Highlight Aimbot Target", "color", true)
					...
					for curplayer = 1, #players do
						...
						if client.hud:isplayeralive(ply) then
							...
							local distance =
								math.floor((parts.rootpart.Position - Camera.CFrame.Position).Magnitude / 5)
							...
							if (topIsRendered or bottomIsRendered) then
								...
								if nameon or rankon then
									...
									if rankon then
										local playerdata = teamdata[1]:FindFirstChild(ply.Name)
											or teamdata[2]:FindFirstChild(ply.Name)
									...
									allesp[4][1][curplayer].Position =
										Vector2.new(boxPosition.x + boxSize.x * 0.5, boxPosition.y - 15)
								end
								...
								if menu.options["Visuals"][GroupBox]["Health Bar"][1] then
									...
									if
										menu.options["Visuals"][GroupBox]["Health Number"][1]
									...
									then
										...
										hptext.Color =
											menu:GetVal("Visuals", GroupBox, "Health Number", "color", true)
								...
								if menu:GetVal("Visuals", "Player ESP", "Health Number") then
									...
									allesp[3][1][curplayer].Position =
										Vector2.new(math.floor(boxPosition.x) - 6, math.floor(boxPosition.y) - 1)
								...
								if menu.options["Visuals"][GroupBox]["Held Weapon"][1] then
									...
									weptext.Position =
										Vector2.new(boxPosition.x + boxSize.x * 0.5, boxPosition.y + boxSize.y)
								...
								if menu.options["Visuals"][GroupBox]["Skeleton"][1] then
									...
									for k2, v2 in ipairs(skelparts) do
										...
										local posie =
											Camera:WorldToViewportPoint(ply.Character:FindFirstChild(v2).Position)
								...
								if
									menu:GetVal("Visuals", "ESP Settings", "Highlight Priority")
									and table.find(menu.priority, ply.Name)
								then
								...
								elseif
									menu:GetVal("Visuals", "ESP Settings", "Highlight Friends")
									and table.find(menu.friends, ply.Name)
								then
								...
								then
									...
									allesp[4][1][curplayer].Color =
										menu:GetVal("Visuals", GroupBox, "Name", "color", true) -- RGB(menu.options["Visuals"][GroupBox]["Name"][5][1][1], menu.options["Visuals"][GroupBox]["Name"][5][1][2], menu.options["Visuals"][GroupBox]["Name"][5][1][3])
									allesp[4][1][curplayer].Transparency = menu:GetVal("Visuals", GroupBox, "Name", "color")[4] / 255

									allesp[2][2][curplayer].Color =
										menu:GetVal("Visuals", GroupBox, "Box", "color", true)

									allesp[4][2][curplayer].Color =
										menu:GetVal("Visuals", GroupBox, "Held Weapon", "color", true)
									allesp[4][2][curplayer].Transparency = menu:GetVal("Visuals", GroupBox, "Held Weapon", "color")[4] / 255

									allesp[4][3][curplayer].Color =
										menu:GetVal("Visuals", GroupBox, "Distance", "color", true)
							...
							elseif
								GroupBox == "Enemy ESP"
								and menu:GetVal("Visuals", "Enemy ESP", "Out of View")
							then
								...
								for i = 1, 2 do
									...
									local arrow_size = menu:GetVal("Visuals", "Enemy ESP", "Dynamic Arrow Size")
											and map(distance, 1, 100, 50, 15)
										or 15
					...
					--ANCHOR weapon esp
					if
						menu:GetVal("Visuals", "Dropped ESP", "Weapon Names")
						or menu:GetVal("Visuals", "Dropped ESP", "Weapon Ammo")
					then
						...
						for k, v in pairs(workspace.Ignore.GunDrop:GetChildren()) do
							...
							if v.Name == "Dropped" then
								...
								if gun_dist < 80 then
									local hasgun = false
									local gunpos2d, gun_on_screen =
										workspace.CurrentCamera:WorldToScreenPoint(gunpos)
									...
									if gun_on_screen and gunnum <= 50 and hasgun then
										...
										if menu:GetVal("Visuals", "Dropped ESP", "Weapon Names") then
											if
												client.logic.currentgun
												and client.logic.currentgun
												and client.logic.currentgun.data
												and v.Gun.Value == client.logic.currentgun.data.name
											then
											...
											wepesp[1][gunnum].Position =
												Vector2.new(math.floor(gunpos2d.x), math.floor(gunpos2d.y + 25))
										end
										if menu:GetVal("Visuals", "Dropped ESP", "Weapon Ammo") then
											...
											wepesp[2][gunnum].Position =
												Vector2.new(math.floor(gunpos2d.x), math.floor(gunpos2d.y + 36))
										end
									end
								end
							end
					...
					if menu:GetVal("Visuals", "Dropped ESP", "Grenade Warning") then
						...
						for i = 1, #menu.activenades do
							...
							if nade_dist <= 80 then
								local nadepos, nade_on_screen =
									workspace.CurrentCamera:WorldToScreenPoint(Vector3.new(nade.blowupat.x, nade.blowupat.y, nade.blowupat.z))
								...
								nade_esp[1][i].Position =
									Vector2.new(math.floor(nadepos.x), math.floor(nadepos.y + 36))

								nade_esp[2][i].Visible = true
								nade_esp[2][i].Position =
									Vector2.new(math.floor(nadepos.x), math.floor(nadepos.y + 36))

								nade_esp[4][i].Visible = true
								nade_esp[4][i].Position =
									Vector2.new(math.floor(nadepos.x) - 10, math.floor(nadepos.y + 10))

								nade_esp[3][i].Visible = true
								nade_esp[3][i].Position =
									Vector2.new(math.floor(nadepos.x), math.floor(nadepos.y + 36))
								...
								local damage = nade_dist < r0 and d0
									or nade_dist < r1 and (d1 - d0) / (r1 - r0) * (nade_dist - r0) + d0
									or 0
								...
								local str = damage == 0 and "Safe"
									or damage >= health and "LETHAL"
									or string.format("-%d hp", damage)
								...
								nade_esp[5][i].Position =
									Vector2.new(math.floor(nadepos.x) - 16, math.floor(nadepos.y + 50))

								nade_esp[6][i].Visible = true
								nade_esp[6][i].Position =
									Vector2.new(math.floor(nadepos.x) - 15, math.floor(nadepos.y + 51))

								nade_esp[7][i].Visible = true
								nade_esp[7][i].Size = Vector2.new(30 * (1 - nade_percent), 2)
								nade_esp[7][i].Position =
									Vector2.new(math.floor(nadepos.x) - 15, math.floor(nadepos.y + 51))
								nade_esp[7][i].Color = color1

								nade_esp[8][i].Visible = true
								nade_esp[8][i].Size = Vector2.new(30 * (1 - nade_percent), 2)
								nade_esp[8][i].Position =
									Vector2.new(math.floor(nadepos.x) - 15, math.floor(nadepos.y + 53))
							...
							for k1, v1 in pairs(v:GetChildren()) do
								...
								if v1.Transparency ~= 1 then
									if wepcham then
										...
										if not client.fakecharacter then
											v1.Transparency = client.logic.currentgun.transparencydata
													and client.logic.currentgun.transparencydata[v1]
												or 0
										else
											v1.Transparency = 0.999999
										end
								...
								elseif v1.Name == "SightMark" and wepcham then
									if v1:FindFirstChild("SurfaceGui") then
										local color =
											menu:GetVal("Visuals", "Local", "Weapon Chams", "color2", true)
										local transparency = 1  + (
												menu:GetVal("Visuals", "Local", "Weapon Chams", "color2")[4] / -255
											)
				...
				if menu:GetVal("Visuals", "Keybinds", "Enabled") then
					...
					for i = 1, #menu.keybinds do
						...
						if
							keybind
							and keybind[1]
							and menu:GetVal(keybind[4], keybind[3], keybind[2])
							and menu:GetKey(keybind[4], keybind[3], keybind[2])
						then
					...
					for i = 1, 2 do
						...
						local color =
							(
								menu:GetVal("Settings", "Cheat Settings", "Menu Accent")
									and menu:GetVal("Settings", "Cheat Settings", "Menu Accent", "color", true)
								or Color3.fromRGB(127, 72, 163)
							)
						color = i == 1 and color
							or Color3.fromRGB(color.R * 255 - 40, color.G * 255 - 40, color.B * 255 - 40) -- super shit
						box.Color = color
			...
			menu.connections.dropweaponadded = workspace.Ignore.GunDrop.ChildAdded:Connect(function(newchild)
				if menu:GetVal("Visuals", "Dropped ESP", "Dropped Weapon Chams") then
					...
					for i = 1, #children do
						...
						if
							not curvalue:IsA("Model")
							and curvalue.Name ~= "Humanoid"
							and curvalue.ClassName == "Part"
						then
							curvalue.Color =
								menu:GetVal("Visuals", "Dropped ESP", "Dropped Weapon Chams", "color", true)
							local vertexcolor = Vector3.new(curvalue.Color.R, curvalue.Color.G, curvalue.Color.B)
							local mesh = curvalue:FindFirstChild("Mesh")
				...
				if actionName == "BB PF check" then
					if inputState == Enum.UserInputState.Begin then
						...
						if shitting_my_pants == false then
							if
								menu:GetVal("Misc", "Exploits", "Vertical Floor Clip")
								and inputObject.KeyCode == menu:GetVal("Misc", "Exploits", "Vertical Floor Clip", "keybind")
								and client.char.alive
							then
								...
								local ray = Ray.new(
									...
									forward and Camera.CFrame.LookVector * 20
										or Vector3.new(0, sign and -90 or 90, 0) * 20
								)
						...
						if
							menu:GetVal("Misc", "Exploits", "Rapid Kill")
							and inputObject.KeyCode == menu:GetVal("Misc", "Exploits", "Rapid Kill", "keybind")
						then
							misc:RapidKill()
							return Enum.ContextActionResult.Sink
						end
						if
							menu:GetVal("Misc", "Exploits", "Teleport")
							and inputObject.KeyCode == menu:GetVal("Misc", "Exploits", "Teleport", "keybind")
						then
							misc:Teleport()
							return Enum.ContextActionResult.Sink
						end
						if
							menu:GetVal("Misc", "Exploits", "Invisibility")
							and inputObject.KeyCode == menu:GetVal("Misc", "Exploits", "Invisibility", "keybind")
						then
		...
		if chat_box.Active then return end
			...
			menu.connections.renderstepped_pf = game.RunService.RenderStepped:Connect(function()
				...
				if
					client.char.alive
					and menu:GetVal("Misc", "Exploits", "Rapid Kill")
					and menu:GetVal("Misc", "Exploits", "Auto Rapid Kill")
				then
				...
				if
					menu:GetVal("Rage", "Fake Lag", "Enabled")
					and menu:GetKey("Rage", "Fake Lag", "Manual Choke")
				then
			...
			menu.connections.heartbeat_pf = game.RunService.Heartbeat:Connect(function()
							...
							for i = 1, #upvs do
								...
								if type(curv) == "function" and getinfo(curv).name:match("bob") then
									...
									setupvalue(client.loadedguns[id].step, i, function(...)
										return (
													menu
													and menu:GetVal("Visuals", "Camera Visuals", "No Gun Bob or Sway")
												)
												and CFrame.new()
											or curv(...)
									end)
										...
										setrawmetatable(lol, {
											__newindex = function(t, p, v)
												if menu then
													if
														p == "a"
														and menu:GetVal("Misc", "Weapon Modifications", "Enabled")
				...
				if
					menu:GetVal("Visuals", "Local", "Third Person")
					and not keybindtoggles.superaa
					and menu:GetKey("Visuals", "Local", "Third Person")
				then -- do third person model
					if client.char.alive then
						...
						if not client.fakecharacter then
							...
							local guntoequip = client.logic.currentgun.type == "KNIFE" and client.loadedguns[1].name
								or client.logic.currentgun.name -- POOP
							client.fakeupdater.equip(
							...
							if
								...
								and LOCAL_PLAYER.Character.Torso
								and LOCAL_PLAYER.Character.Torso:FindFirstChild("Pant")
							then
							...
							if not menu:GetKey("Rage", "Fake Lag", "Manual Choke") then
								...
								if lchams then
									local lchamscolor =
										menu:GetVal("Visuals", "Local", "Local Player Chams", "color", true)
								...
								if menu:GetVal("Rage", "Anti Aim", "Enabled") then
									...
									local silentangles = ragebot.silentVector
											and Vector3.new(CFrame.new(Vector3.new(), ragebot.silentVector):ToOrientation())
										or nil
								...
								if client.logic.currentgun then
									if client.logic.currentgun.type ~= "KNIFE" then
										...
										for k, v in next, client.fake3pchar:GetChildren() do -- this is probably going to cause a 1 fps drop or some shit lmao
											if v:IsA("BasePart") and v.Name ~= "HumanoidRootPart" then
												v.Transparency = bool and map(transparency, 0, 1, 0.5, 1)
													or transparency
											end
											if v:IsA("Model") then
			...
			do
				...
				local function setplistinfo(player, textonly)
					if player ~= nil then
						...
						local playerdata = teamdata[1]:FindFirstChild(player.Name)
							or teamdata[2]:FindFirstChild(player.Name)
						...
						if menu.tabnames[menu.activetab] == "Settings" and menu.open then
							...
							if selectedPlayer ~= nil then
								if menu:MouseInMenu(28, 68, 448, 238) then
									if table.find(menu.friends, selectedPlayer.Name) then
										menu.options["Settings"]["Player List"]["Player Status"][1] = 2
										menu.options["Settings"]["Player List"]["Player Status"][4][1].Text =
											"Friend"
									elseif table.find(menu.priority, selectedPlayer.Name) then
										menu.options["Settings"]["Player List"]["Player Status"][1] = 3
										menu.options["Settings"]["Player List"]["Player Status"][4][1].Text =
